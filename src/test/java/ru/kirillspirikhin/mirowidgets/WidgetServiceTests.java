...
public class WidgetServiceTests {
  ...
  void getAllWidgetsTest() {
    ...
    widgetService.addWidget(WidgetDescription.builder()
        ...
        .height(Math.abs(r.nextInt()))
        .width(Math.abs(r.nextInt())).build());
    Assertions.assertEquals(2, widgetService.getAllWidgets().getWidgets().length);
  ...
  @Test
  @DisplayName("Получение страницы виджетов")
  void getWidgetsPageTest() {
    log.info("getWidgetsPageTest start");
    Random r = new Random();
    for (int i = 0; i < 11; i++) {
      widgetService.addWidget(WidgetDescription.builder()
          .x(r.nextInt())
    ...
    Assertions.assertEquals(10, widgetService.getAllWidgets(PageRequest.of(0, 10)).getWidgets().length);
    Assertions.assertEquals(1, widgetService.getAllWidgets(PageRequest.of(1, 10)).getWidgets().length);
    log.info("getWidgetsPageTest finish");
  }
}
